...
function encode (data) {
  // '@' is required so the encoding corresponds to the later decoded value we expect
...
module.exports.findNextMessage = function (inbox, lastHash) {
  ...
  // Requires the path to resolve
  var filePath = require.resolve(path.join(inbox.dir, inbox.messages[found].hash));

  // readFileSync is used instead since we seem to want this to sun synchronously
